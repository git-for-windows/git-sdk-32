/*** Autogenerated by WIDL 1.6 from include/uiautomationcore.idl - Do not edit ***/
...
HRESULT STDMETHODCALLTYPE IRawElementProviderSimple_get_ProviderOptions_Proxy(
    IRawElementProviderSimple* This,
    enum ProviderOptions *pRetVal);
void __RPC_STUB IRawElementProviderSimple_get_ProviderOptions_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRawElementProviderSimple_GetPatternProvider_Proxy(
    IRawElementProviderSimple* This,
    PATTERNID patternId,
    IUnknown **pRetVal);
void __RPC_STUB IRawElementProviderSimple_GetPatternProvider_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRawElementProviderSimple_GetPropertyValue_Proxy(
    IRawElementProviderSimple* This,
    PROPERTYID propertyId,
    VARIANT *pRetVal);
void __RPC_STUB IRawElementProviderSimple_GetPropertyValue_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRawElementProviderSimple_get_HostRawElementProvider_Proxy(
    IRawElementProviderSimple* This,
    IRawElementProviderSimple **pRetVal);
void __RPC_STUB IRawElementProviderSimple_get_HostRawElementProvider_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IAccessibleEx_GetObjectForChild_Proxy(
    IAccessibleEx* This,
    LONG idChild,
    IAccessibleEx **pRetVal);
void __RPC_STUB IAccessibleEx_GetObjectForChild_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IAccessibleEx_GetIAccessiblePair_Proxy(
    IAccessibleEx* This,
    IAccessible **ppAcc,
    LONG *pidChild);
void __RPC_STUB IAccessibleEx_GetIAccessiblePair_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IAccessibleEx_GetRuntimeId_Proxy(
    IAccessibleEx* This,
    SAFEARRAY **pRetVal);
void __RPC_STUB IAccessibleEx_GetRuntimeId_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IAccessibleEx_ConvertReturnedElement_Proxy(
    IAccessibleEx* This,
    IRawElementProviderSimple *pIn,
    IAccessibleEx **ppRetValOut);
void __RPC_STUB IAccessibleEx_ConvertReturnedElement_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
