...
cccdlflags=' '
ccdlflags=' '
ccflags='-DPERL_USE_SAFE_PUTENV -D_GNU_SOURCE -U__STRICT_ANSI__ -march=i686 -mtune=generic -O2 -pipe -fwrapv -fno-strict-aliasing -fstack-protector-strong -D_FORTIFY_SOURCE=2'
...
cf_email=''
cf_time='Tue Feb 13 05:22:58 PST 2018'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
config_arg23='-Dld=g++'
config_arg24='-Accflags=-march=i686 -mtune=generic -O2 -pipe -fwrapv'
...
config_argc='24'
config_args='-des -Dusethreads -Doptimize=-march=i686 -mtune=generic -O2 -pipe -Dprefix=/usr -Dvendorprefix=/usr -Dprivlib=/usr/share/perl5/core_perl -Darchlib=/usr/lib/perl5/core_perl -Dsitelib=/usr/share/perl5/site_perl -Dsitearch=/usr/lib/perl5/site_perl -Dvendorlib=/usr/share/perl5/vendor_perl -Dvendorarch=/usr/lib/perl5/vendor_perl -Dscriptdir=/usr/bin/core_perl -Dsitescript=/usr/bin/site_perl -Dvendorscript=/usr/bin/vendor_perl -Dinc_version_list=none -Dnoextensions=DB_File GDBM_File NDBM_File ODBM_File SDBM_File -Dman1ext=1perl -Dman3ext=3perl -Darchname=-msys-threads -Dmyarchname=-msys -Dlibperl=msys-perl5_26.dll -Dcc=gcc -Dld=g++ -Accflags=-march=i686 -mtune=generic -O2 -pipe -fwrapv'
contains='grep'
cp='cp'
cpio=''
cpp='cpp'
cpp_stuff='42'
cppccsymbols='unix=1'
cppflags='-DPERL_USE_SAFE_PUTENV -D_GNU_SOURCE -U__STRICT_ANSI__ -march=i686 -mtune=generic -O2 -pipe -fwrapv -fno-strict-aliasing -fstack-protector-strong'
cpplast='-'
cppminus='-'
cpprun='gcc  -E'
cppstdin='gcc  -E'
cppsymbols='__BIG_ENDIAN=4321 __BYTE_ORDER__=1234 __BYTE_ORDER=1234 __CYGWIN__=1 __GNUC__=6 __GNUC_MINOR__=4 __i386__=1 __i386=1 __i686__=1 __i686=1 __LITTLE_ENDIAN=1234 __MSYS__=1 __STDC__=1 __unix__=1 __unix=1 _BIG_ENDIAN=4321 _BYTE_ORDER=1234 _GNU_SOURCE=1 _LITTLE_ENDIAN=1234 _LONG_DOUBLE=long\ double _POSIX_C_SOURCE=200809L _POSIX_SOURCE=1 _XOPEN_SOURCE_EXTENDED=1 _XOPEN_SOURCE=700 BIG_ENDIAN=4321 BYTE_ORDER=1234 i386=1 LITTLE_ENDIAN=1234'
...
incpath=''
incpth='/usr/lib/gcc/i686-pc-msys/6.4.0/include /usr/include'
inews=''
...
myuname='msys_nt-10.0-wow ab2b9a2ab836 2.10.0(0.32553) 2018-02-12 08:26 i686 msys '
n='-n'
need_va_copy='undef'
netdb_hlen_type='int'
...
ccflags_nolargefiles='-DPERL_USE_SAFE_PUTENV -D_GNU_SOURCE -U__STRICT_ANSI__ -march=i686 -mtune=generic -O2 -pipe -fwrapv -fno-strict-aliasing -fstack-protector-strong -D_FORTIFY_SOURCE=2'
