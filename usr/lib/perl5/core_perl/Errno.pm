...
"i686-msys-thread-multi-64int-3.1.4-340.i686" or
	die "Errno architecture (i686-msys-thread-multi-64int-3.1.4-340.i686) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
