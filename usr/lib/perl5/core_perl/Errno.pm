...
"i686-msys-thread-multi-64int-2.7.0(0.30653)" or
	die "Errno architecture (i686-msys-thread-multi-64int-2.7.0(0.30653)) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
