...
"i686\-cygwin\-thread\-multi\-64int-3\.3\.6\-341\.i686" or
	die "Errno architecture (i686\-cygwin\-thread\-multi\-64int-3\.3\.6\-341\.i686) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
