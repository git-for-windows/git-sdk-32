...
"i686-msys-thread-multi-64int-2.9.0(0.31853)" or
	die "Errno architecture (i686-msys-thread-multi-64int-2.9.0(0.31853)) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
