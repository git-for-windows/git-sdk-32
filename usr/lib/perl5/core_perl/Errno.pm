...
"i686-msys-thread-multi-64int-2.5.0(0.29453)" or
	die "Errno architecture (i686-msys-thread-multi-64int-2.5.0(0.29453)) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
