...
_client.SVN_CLIENT_COMMIT_ITEM_ADD_swigconstant(_client)
SVN_CLIENT_COMMIT_ITEM_ADD = _client.SVN_CLIENT_COMMIT_ITEM_ADD

_client.SVN_CLIENT_COMMIT_ITEM_DELETE_swigconstant(_client)
SVN_CLIENT_COMMIT_ITEM_DELETE = _client.SVN_CLIENT_COMMIT_ITEM_DELETE

_client.SVN_CLIENT_COMMIT_ITEM_TEXT_MODS_swigconstant(_client)
SVN_CLIENT_COMMIT_ITEM_TEXT_MODS = _client.SVN_CLIENT_COMMIT_ITEM_TEXT_MODS

_client.SVN_CLIENT_COMMIT_ITEM_PROP_MODS_swigconstant(_client)
SVN_CLIENT_COMMIT_ITEM_PROP_MODS = _client.SVN_CLIENT_COMMIT_ITEM_PROP_MODS

_client.SVN_CLIENT_COMMIT_ITEM_IS_COPY_swigconstant(_client)
SVN_CLIENT_COMMIT_ITEM_IS_COPY = _client.SVN_CLIENT_COMMIT_ITEM_IS_COPY

_client.SVN_CLIENT_COMMIT_ITEM_LOCK_TOKEN_swigconstant(_client)
SVN_CLIENT_COMMIT_ITEM_LOCK_TOKEN = _client.SVN_CLIENT_COMMIT_ITEM_LOCK_TOKEN

_client.SVN_CLIENT_COMMIT_ITEM_MOVED_HERE_swigconstant(_client)
...
_client.svn_client_diff_summarize_kind_normal_swigconstant(_client)
svn_client_diff_summarize_kind_normal = _client.svn_client_diff_summarize_kind_normal

_client.svn_client_diff_summarize_kind_added_swigconstant(_client)
svn_client_diff_summarize_kind_added = _client.svn_client_diff_summarize_kind_added

_client.svn_client_diff_summarize_kind_modified_swigconstant(_client)
svn_client_diff_summarize_kind_modified = _client.svn_client_diff_summarize_kind_modified

_client.svn_client_diff_summarize_kind_deleted_swigconstant(_client)
...
_client.SVN_CLIENT_AUTH_USERNAME_swigconstant(_client)
SVN_CLIENT_AUTH_USERNAME = _client.SVN_CLIENT_AUTH_USERNAME

_client.SVN_CLIENT_AUTH_PASSWORD_swigconstant(_client)
...
_client.SWIG_SVN_INFO_SIZE_UNKNOWN_swigconstant(_client)
SWIG_SVN_INFO_SIZE_UNKNOWN = _client.SWIG_SVN_INFO_SIZE_UNKNOWN

_client.svn_swig_py_cancel_func_swigconstant(_client)
svn_swig_py_cancel_func = _client.svn_swig_py_cancel_func

_client.svn_swig_py_get_commit_log_func_swigconstant(_client)
svn_swig_py_get_commit_log_func = _client.svn_swig_py_get_commit_log_func

_client.svn_swig_py_notify_func_swigconstant(_client)
svn_swig_py_notify_func = _client.svn_swig_py_notify_func

_client.svn_swig_py_notify_func2_swigconstant(_client)
