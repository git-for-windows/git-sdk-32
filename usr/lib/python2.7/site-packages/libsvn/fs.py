...
_fs.svn_fs_upgrade_pack_revprops_swigconstant(_fs)
svn_fs_upgrade_pack_revprops = _fs.svn_fs_upgrade_pack_revprops

_fs.svn_fs_upgrade_cleanup_revprops_swigconstant(_fs)
svn_fs_upgrade_cleanup_revprops = _fs.svn_fs_upgrade_cleanup_revprops

_fs.svn_fs_upgrade_format_bumped_swigconstant(_fs)
...
_fs.svn_fs_node_unrelated_swigconstant(_fs)
svn_fs_node_unrelated = _fs.svn_fs_node_unrelated

_fs.svn_fs_node_unchanged_swigconstant(_fs)
svn_fs_node_unchanged = _fs.svn_fs_node_unchanged

_fs.svn_fs_node_common_ancestor_swigconstant(_fs)
...
_fs.SVN_FS_TXN_CHECK_OOD_swigconstant(_fs)
SVN_FS_TXN_CHECK_OOD = _fs.SVN_FS_TXN_CHECK_OOD

_fs.SVN_FS_TXN_CHECK_LOCKS_swigconstant(_fs)
SVN_FS_TXN_CHECK_LOCKS = _fs.SVN_FS_TXN_CHECK_LOCKS

_fs.SVN_FS_TXN_CLIENT_DATE_swigconstant(_fs)
...
_fs.svn_fs_path_change_modify_swigconstant(_fs)
svn_fs_path_change_modify = _fs.svn_fs_path_change_modify

_fs.svn_fs_path_change_add_swigconstant(_fs)
svn_fs_path_change_add = _fs.svn_fs_path_change_add

_fs.svn_fs_path_change_delete_swigconstant(_fs)
svn_fs_path_change_delete = _fs.svn_fs_path_change_delete

_fs.svn_fs_path_change_replace_swigconstant(_fs)
svn_fs_path_change_replace = _fs.svn_fs_path_change_replace

_fs.svn_fs_path_change_reset_swigconstant(_fs)
...
_fs.svn_fs_pack_notify_start_swigconstant(_fs)
svn_fs_pack_notify_start = _fs.svn_fs_pack_notify_start

_fs.svn_fs_pack_notify_end_swigconstant(_fs)
svn_fs_pack_notify_end = _fs.svn_fs_pack_notify_end

_fs.svn_fs_pack_notify_start_revprop_swigconstant(_fs)
svn_fs_pack_notify_start_revprop = _fs.svn_fs_pack_notify_start_revprop

_fs.svn_fs_pack_notify_end_revprop_swigconstant(_fs)
