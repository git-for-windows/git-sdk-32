...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
           '-Wstrict-prototypes -march=i686 -mtune=generic -O2 -pipe',
 'CFLAGSFORSHARED': '',
 'CFLAGS_NODIST': '',
 ...
 'CONFIG_ARGS': "'--prefix=/usr' '--build=i686-pc-msys' '--host=i686-pc-msys' "
                ...
                "'--with-system-ffi' '--with-threads' '--with-system-libmpdec' "
                ...
                "-L.' 'CPPFLAGS=-D_FORTIFY_SOURCE=2 -I/usr/include/ncursesw' "
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                   '-Wall -Wstrict-prototypes -march=i686 -mtune=generic -O2 '
