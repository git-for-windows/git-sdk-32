...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIG_ARGS': "'--prefix=/usr' '--build=i686-pc-msys' '--host=i686-pc-msys' "
                ...
                "'build_alias=i686-pc-msys' 'host_alias=i686-pc-msys' "
                "'CFLAGS=-march=i686 -mtune=generic -O2 -pipe' 'LDFLAGS=-pipe "
                "-L.' 'CPPFLAGS= -I/usr/include/ncursesw' "
                "'PKG_CONFIG_PATH=/usr/lib/pkgconfig:/usr/share/pkgconfig:/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.9',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/t/python/src/Python-3.9.5/coverage.info',
 'COVERAGE_REPORT': '/t/python/src/Python-3.9.5/lcov-report',
 ...
 'EXPORTSYMS': '',
 'EXTRATESTOPTS': '',
 'EXT_SUFFIX': '.cpython-39-i386-msys.dll',
 'FILEMODE': 644,
 ...
 'LIBPL': '/usr/lib/python3.9/config-3.9-i386-msys',
 ...
 'MODULE_OBJS': '\\',
 'MULTIARCH': 'i386-msys',
 'MULTIARCH_CPPFLAGS': '-DMULTIARCH=\\"i386-msys\\"',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g '
                             ...
                             '-march=i686 -mtune=generic -O2 -pipe -std=c99 '
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                   ...
                   '-mtune=generic -O2 -pipe -march=i686 -mtune=generic -O2 '
 ...
 'PY_STDMODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv '
                        ...
                        '-march=i686 -mtune=generic -O2 -pipe -march=i686 '
 ...
 'abs_builddir': '/t/python/src/Python-3.9.5',
 'abs_srcdir': '/t/python/src/Python-3.9.5',
